...
box_setwd(18051534353) #setting working directory to "~/Box Sync/mpc/dataForDemocracy/presidency_project/newspaper/"
box_load(222756201017) #loading file "workspaceR/newspaperExplore.RData" from online box
